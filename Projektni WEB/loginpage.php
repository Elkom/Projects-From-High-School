	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Prijava</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
				...
				<div class="row">
					...
					<center>
						<div class="section-title">
							<h3 class="title">Prijava korisnika</h3>
						</div>
						<?php
								...
								if(!empty($_POST['username']) and !empty($_POST['password'])){
									...
									if(mysqli_num_rows($checklogin) == 1){
										...
										echo '<script type="text/javascript">',
	     									 '$( "#accUL" ).load(window.location.href + " #accUL" );',
												 '</script>';
									}
									else{
										$_SESSION['login'] = "";
							...
							if($writeForm == true){
								...
								<form action="loginpage.php" method="post">
									...
									<div class="form-group">
										...
										<div class="form-group">
											<button type="submit" name="prijava" class="primary-btn cta-btn">Prijava</button>
										</div>
											<span>Nemate korisnički račun? <a href="register.php">Registrujte se</a>!</span>
								</form>
								<?php
							}
						?>
								...
								if(isset($_POST['submitNews'])){
									...
									if($_SERVER['REQUEST_METHOD'] == 'POST'){
										...
										if($checkmail != 0){
											...
											echo "<br><a href=\"loginpage.php\">Pokušajte ponovo</a>";
										}
										else{
